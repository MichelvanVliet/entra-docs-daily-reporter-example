...
Delivery model: the workflow posts a daily GitHub issue with Markdown tables. If the daily issue already exists, it adds a refresh comment that includes the latest report so GitHub issue notifications still provide the email delivery.
